    ...
    <div className="flex flex-col justify-center min-h-[80vh]">
      ...
      <div className="space-y-6 max-w-2xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
          <Link href="/articles" className="group border border-border p-4 rounded hover:border-primary transition-colors">
            <h3 className="font-mono text-zinc-100 flex items-center gap-2">
              /articles <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
            </h3>
            <p className="text-sm text-zinc-500 mt-2">Deep dives into tech & math.</p>
          </Link>
          
          <Link href="/projects" className="group border border-border p-4 rounded hover:border-primary transition-colors">
            <h3 className="font-mono text-zinc-100 flex items-center gap-2">
